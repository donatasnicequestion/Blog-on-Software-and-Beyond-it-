package com.nicequestion.donatas.adf.extentions;
 ...
 *  
 */
@FacesBehavior("donatas.nicequestion.com.adf.extentions.initialFocus")
public class SetInitialFocusBehavior extends ClientBehaviorBase {
    ...
    public String getScript(ClientBehaviorContext clientBehaviorContext) {
        ...
        // Nothing to return. Unfortunatly no success on returning Javascript here :( Why - timing issue ?
        // An alternative implementation based on ExtendedRenderKitService was choosed to fire a javascript
        return "";
    }
